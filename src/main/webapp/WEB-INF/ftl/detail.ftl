...
<head>
    ...
    <script>
        ...
        $(function() {
            <#if userReadState??>
                $("*[data-read-state='${userReadState.readState}']").addClass("highlight");
            </#if>
            ...
            <#if loginUser??>
                ...
                $("*[data-evaluation-id]").click(function () {
                    ...
                    $.post("/enjoy", {
                        ...
                        if (res.code == 0) {
                            $("*[data-evaluation-id='" + evaluationId + "'] span").text(res.evaluation.enjoy);
                        }
                    }, "json");
                });
            </#if>
    ...
    <div class="reply pl-2 pr-2">
        <#list evaluationList as evaluation>
            <div>
                ...
                <span class="mr-2 small pt-1">${evaluation.user.nickname}</span>
